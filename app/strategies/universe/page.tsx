...
export const metadata: Metadata = {
  title: "Universe",
  description: "Dated cash-and-carry universe: live book, top opportunities, and paper desk.",
};
...
export default async function UniversePage({
  ...
  const paper = await getOpportunityPaperProps("/strategies/universe");
  ...
  return (
    <main className="mx-auto max-w-6xl space-y-8 px-6 py-8">
      <PageHeading overline="Strategies · Universe" title="Cash and carry" />
      ...
      <p className="text-sm text-ink-faint">
        <Link href="/strategies/universe/pairs" className="text-accent">
          Full pair list
        </Link>
        {" · "}
        Live Bybit public books. No API key.
