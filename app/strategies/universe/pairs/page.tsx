...
export default async function UniversePairsPage() {
  let pairs: CarryPair[] = [];
  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-8">
      <PageHeading overline="Strategies · Universe" title="Pairs" />
      <p className="-mt-2 text-sm text-ink-muted">
        Scan list of Bybit USDT expiry contracts and matching USDT spot. No
        API key. BTC, ETH, SOL, DOGE, XRP, MNT only. Perps are excluded.
      </p>
      {error ? (
