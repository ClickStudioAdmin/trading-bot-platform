...
export default async function UniverseOpportunitiesPage({
  searchParams,
}: {
  ...
  const paper = await getOpportunityPaperProps("/strategies/universe/opportunities");
  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-8">
      <PageHeading overline="Strategies · Universe" title="Opportunities" />
