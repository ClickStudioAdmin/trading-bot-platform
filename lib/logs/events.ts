export const EVENT_LOG_OPTIONS = [
  ...
  { event: "copy.follower_settings_saved", scope: "system" },
  { event: "copy.paused", scope: "trade" },
  { event: "copy.resumed", scope: "trade" },
  { event: "copy.unfollowed", scope: "system" },
  { event: "copy.followed", scope: "trade" },
  { event: "copy.copied", scope: "trade" },
  { event: "copy.copy_skipped", scope: "trade" },
  { event: "copy.cycle_skipped", scope: "trade" },
  { event: "copy.limit_copied", scope: "trade" },
  { event: "copy.limit_amended", scope: "trade" },
  { event: "copy.limit_cancelled", scope: "trade" },
  { event: "copy.breach_flattened", scope: "trade" },
  { event: "copy.fanout_failed", scope: "trade" },
  ...
  { event: "membership.plan_updated", scope: "system" },
