export const EVENT_LOG_OPTIONS = [
  ...
  { event: "membership.billing_method", scope: "system" },
  ...
  { event: "membership.invoice_voided", scope: "system" },
  ...
  { event: "membership.deposit_credited", scope: "system" },
  { event: "membership.deposit_swept", scope: "system" },
  { event: "membership.sweep_failed", scope: "system" },
  { event: "membership.gas_low", scope: "system" },
  ...
  { event: "dca.sync_failed", scope: "trade" },
