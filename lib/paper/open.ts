...
export type OpportunityPaperProps = {
  signedIn: boolean;
  openKeys: Set<string>;
  next: "/opportunities" | "/cash-and-carry";
};
...
export function safePaperReturnPath(raw: string): "/opportunities" | "/cash-and-carry" {
  return raw === "/cash-and-carry" ? "/cash-and-carry" : "/opportunities";
}
