...
assert.equal(formatGroupedNumberInput("-0.2", true, true), "-0.2");
assert.equal(formatGroupedNumberInput("-1234.5", true, true), "-1,234.5");
assert.equal(formatGroupedNumberInput("-", true, true), "-");
assert.equal(formatGroupedNumberInput("-0.2", true, false), "0.2");
