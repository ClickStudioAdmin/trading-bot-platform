...
**Bot form (draft)** on this page: proposed standard for every desk (Off, not a checkbox that hides exits; same section order). Local mock only. Do not apply to live Perps / DCA / backtest forms until Click signs it.
