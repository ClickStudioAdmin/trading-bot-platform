...
The scale is on **Theme → Cards** (`/admin/theme?tab=cards`), with what is still inconsistent. Live card titles are 18px. Field labels are 14px ink (white in dark mode). Card intros are 14px muted. Helpers under fields are 12px muted.
