...
| `mode-demo` | `#3E9A96` | Desk mode Demo / testnet. Dusty teal, not pending amber. |
| `mode-live` | `#7A86C0` | Desk mode Live. Dusty indigo, not danger red and not accent purple. |
