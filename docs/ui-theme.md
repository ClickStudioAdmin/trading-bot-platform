...
Geist. Page title 30–36px semibold. Section 18–20px semibold. Body 14px. Labels 14px ink, sentence case (`text-sm text-ink`). Helpers under a field are 12px muted. Hints 13px faint (`text-hint`), sentence case — live helpers use this step. KPI values 24–32px semibold tabular.
