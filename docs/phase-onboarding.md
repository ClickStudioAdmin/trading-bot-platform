...
Postponed. Not the current phase. **Not Phase 12** (scale-in). Do not implement until Click starts this work.
...
- Backup market-data vendors ([master-spec.md](master-spec.md) Later)
