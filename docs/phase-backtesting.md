...
| Detail | `/account/backtests/[runId]` and `/admin/backtests/[runId]`. Parameters, stats, equity chart, inline chart, paged completed trades. Open positions at the window end are noted as current trades and omitted from the list. |
