...
| 5 | **Plans, payments, and affiliates** | Combined old 8 + 11. Spec: [phase-membership.md](phase-membership.md). Steps 1–3 in repo (schema, `/admin/plans`, `/account/plans`). No Stripe until step 4 (`/account/billing` ships with Stripe). Upgrade UX / gates are step 10. |
