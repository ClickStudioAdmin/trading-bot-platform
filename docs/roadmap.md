...
| 4 | **Account Positions, Bots, and Automations lists** | Login-wide Positions + Bots. Desk Automations becomes a bot table + Create New Bot + Edit. Spec: [phase-account-blotter.md](phase-account-blotter.md). Locked 19 Sep 2026. Do not start until item 3 is accepted. |
