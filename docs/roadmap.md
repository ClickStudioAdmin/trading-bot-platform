...
| 5 | **Plans, payments, and affiliates** | Combined old 8 + 11. Freemium, admin plan catalog, Stripe cards, crypto credit wallet, multi-level affiliate % of subscription. Spec: [phase-membership.md](phase-membership.md). Docs only until Click starts this item. No `plan_*` tables or Stripe until then. |
