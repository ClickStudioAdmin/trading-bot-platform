...
| 5 | **Plans, payments, and affiliates** | Combined old 8 + 11. Spec: [phase-membership.md](phase-membership.md). Steps 1–8 in repo (schema, plan pages, Stripe + `/account/billing`, two USD books, unique EVM deposits, affiliate admin/portal/commissions). Next is step 9 (entitlements + Upgrade UX). Downgrade grace is step 10. |
