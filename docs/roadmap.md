...
- **Adaptive DCA filters and exits** — [phase-adaptive.md](phase-adaptive.md). Trend start (Supertrend) is already on the playbook. Do not implement filters until Click says go.
