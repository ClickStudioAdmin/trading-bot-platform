...
| 5 | **Plans, payments, and affiliates** | Combined old 8 + 11. Spec: [phase-membership.md](phase-membership.md). Steps 1–5 in repo (schema, plan pages, Stripe + `/account/billing`, two USD books, unique EVM deposits on public RPCs). Next is step 6 (grace). Upgrade UX / gates are step 10. |
