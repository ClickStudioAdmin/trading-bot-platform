...
| 5 | **Plans, payments, and affiliates** | Combined old 8 + 11. Spec: [phase-membership.md](phase-membership.md). Steps 1–4 in repo (schema, plan pages, Stripe + `/account/billing` method picker). Wallet rails are step 5. Upgrade UX / gates are step 10. |
