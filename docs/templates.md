...
- **Export all** / **Import** on the My Templates / My Folders toolbar, same row as bulk actions, right-aligned just left of **Show Filters**. Import is a modal: pick a JSON file, then choose templates and folders. Shared tabs keep row **Import** / **Remove** only.
