...
**Copy trading is started** (roadmap 3): [phase-copy-trading.md](phase-copy-trading.md). Steps 1–3 are in repo. Stop after each copy-trading micro-step until Click says go. Next is step 4 (trader alias + share). Push `develop` to migrate.
