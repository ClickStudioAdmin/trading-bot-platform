...
**Copy trading is started** (roadmap 3): [phase-copy-trading.md](phase-copy-trading.md). Steps 1–5 are in repo. Stop after each copy-trading micro-step until Click says go. Next is step 6 (catalogue + stats). Push `develop` to migrate.
