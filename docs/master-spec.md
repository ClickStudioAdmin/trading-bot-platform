...
**Copy trading is started** (roadmap 3): [phase-copy-trading.md](phase-copy-trading.md). Steps 1–4 are in repo. Stop after each copy-trading micro-step until Click says go. Next is step 5 (private grants). Push `develop` to migrate.
