...
Complete. Phase 8 is complete. See [phase-8.md](phase-8.md). Phase 10 is complete. See [phase-10.md](phase-10.md). Phase 11 is complete. See [phase-11.md](phase-11.md).
...
Phase accepted. Typed desks are [phase-10.md](phase-10.md). DCA is complete ([phase-11.md](phase-11.md)).
